...
public class EjemploAutomovilEnum {
    public static void main(String[] args) {
        ...
        System.out.println("tipo tipoSubaru: " + tipo.getNombre());
        System.out.println("tipo desc. tipoSubaru:  " + tipo.getDescripcion());
        ...
        switch (tipo){
            ...
            case STATION_WAGON ->
                System.out.println("Es un automvil mas grande, con maleta grande...");
        }
